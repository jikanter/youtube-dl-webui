...
http.createServer(function(request, response) { 
  ...
  if (video.url) { 
    ...
    ytDownloader.on('close', function(code, signal) {
      ...
      response.write('</div>');
      response.write('</form>');
      response.write("<a href='http://it-www:9001/youtube.flv'>Download Video</a> <p>Directions: Right-Click &quot;Download Video&quot;, Then click Save-As to save the video to your desktop</p>");
      response.write('</body>');
      response.write('</html>');
      response.end();
    });
